...
/**
 * PayBuilder is used to configure and build an instance of the SDK.
 */
class PayBuilder
{
     ...
     * @return PayBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): PayBuilder
    {
     ...
     * @return PayBuilder
     */
    public function setSecurity(string $apiKeyAuth): PayBuilder
    {
     ...
     * @return PayBuilder
     */
    public function setSecuritySource(\Closure $securitySource): PayBuilder
    {
        $this->sdkConfig->securitySource = fn () => new Models\Components\Security(apiKeyAuth: $securitySource());
     ...
     * @return PayBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): PayBuilder
    {
     ...
     * @return PayBuilder
     */
    public function setServerIndex(int $serverIdx): PayBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): PayBuilder
    {
