...
namespace Pay;
use Pay\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.1.4 2.593.3 1.0.0 nkwa-pay/sdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Pay::SERVERS[$this->serverIndex])) {
            return Pay::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Pay::SERVERS[$this->serverIndex], []);
